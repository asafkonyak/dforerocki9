...
export function NeonButton({ 
  ...
  const colorClasses = {
    cyan: {
      ...
      secondary: 'bg-[#00f0ff]/40 text-[#00f0ff] border-2 border-[#00f0ff] shadow-[0_0_20px_#00f0ff]/50 hover:bg-[#00f0ff]/50',
    ...
    pink: {
      ...
      secondary: 'bg-[#ff006e]/40 text-[#ff006e] border-2 border-[#ff006e] shadow-[0_0_20px_#ff006e]/50 hover:bg-[#ff006e]/50',
    ...
    yellow: {
      ...
      secondary: 'bg-[#ffff00]/40 text-[#ffff00] border-2 border-[#ffff00] shadow-[0_0_20px_#ffff00]/50 hover:bg-[#ffff00]/60',
