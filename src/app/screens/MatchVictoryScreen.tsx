          ...
          <GlassCard className={`p-8 border-4 ${isWin ? 'border-[#00f0ff]/40 shadow-[0_0_50px_rgba(0,240,255,0.2)]' : 'border-[#ff0033]/40 shadow-[0_0_50px_rgba(255,0,51,0.2)]'} bg-black/60`}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col gap-6">
                <div className={`w-full aspect-video rounded-3xl overflow-hidden border-4 ${isWin ? 'border-[#00f0ff]' : 'border-[#ff0033]'} bg-black relative shadow-2xl`}>
                  {matchData.videoUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-white/10 uppercase font-black tracking-widest italic">
                      No Data Feed
                    </div>
                  )}
                  
                  {/* Replay Overlay */}
                  <div className="absolute top-6 left-6 bg-black/80 px-4 py-2 rounded-xl border border-white/20 flex items-center gap-3">
              ...
              <div className="flex flex-col gap-8 justify-center">
                ...
                <GlassCard className="p-6 border border-white/5 bg-black/40 h-[240px] relative">
